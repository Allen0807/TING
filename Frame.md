...
重複6-1至6-11的步驟後直接把frame load進來即可

![顯示畫面](/docs/new_folder/6-1-1.png)
...
重複7-1至7-2-2的步驟後直接把frame load進來即可(寬6高4)

![顯示畫面](/docs/new_folder/7-1-1.png)
